...
Try changing the order of accuracy in [code:setrun.py].
...
Note that the quality of these results depends on how the parameters
<b>order</b> and <b>mthlim</b> are set in [code:setrun.py].
