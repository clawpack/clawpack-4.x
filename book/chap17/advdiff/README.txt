...
The tridiagonal system is solved using the LAPACK routine in
[code: tridiag.f].

The advection velocity u and diffusion coefficient dcoef are set in
[code: setrun.py].
    
Example [book/chap17/advdiff]
...
<dt>[code: tridiag.f]
<dd>
This subroutine solves the tridiagonal system for Crank-Nicolson on the
diffusion step.
