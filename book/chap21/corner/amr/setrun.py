...
#------------------------------
    ...
    probdata.add_param('zl',     1.0,  'left impedance')
    probdata.add_param('cl',     1.0,  'left sound speed')
    probdata.add_param('zr',     0.5,  'right impedance')
    probdata.add_param('cr',     0.5,  'right sound speed')
    ...
    clawdata.auxtype = ['center','center']
