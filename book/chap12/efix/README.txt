...
This is set in the Riemann solver [code:rp1.f] by modifying the variable efix
and recompiling.

Note: also try changing mx in [code:setrun.py]
...
Note: The solution also looks much smoother if you set order=2 in
[code:rp1.f] instead of order=1.
