...
One-dimensionally radially symmetric solver for the acoustics equations. The
code in this subdirectory should be run to create a fine-grid reference
solution to use in plotting results from the 2d code.

    
Example [book/chap21/acoustics/1drad]
...
<dt>[code: src1.f]
<dd>
This subroutine provides the source term needed to model 2d radially
symmetric flow with the 1d acoustics equations.
